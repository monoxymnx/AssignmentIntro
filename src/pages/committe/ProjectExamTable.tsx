...
export default function ProjectExamTable() {
    ...
    <>
      ...
      <Box sx={{ bgcolor: "#f5f7ff", minHeight: "100vh", py: 6 }}>
        <Container maxWidth="md">
          <Paper elevation={3} sx={{ borderRadius: "16px", p: 3, backgroundColor: "#fff" }}>
            <Typography
              variant="h5"
              sx={{ fontWeight: 600, mb: 3, color: "#2D2C95" }}
              align="center"
            >
              ตารางสอบโครงงาน
            </Typography>
            ...
            <Box sx={{ display: "flex", justifyContent: "center", mt: 3 }}>
              <Button
                ...
                onClick={() => { alert("ไม่ผ่าน"); navigate("/committe-table"); }}
              >
                ไม่ผ่าน
              </Button>
              <Button
                ...
                onClick={() => { alert("ลงนามสำเร็จ"); navigate("/committe-table"); }}
              >
                ผ่าน
              </Button>
            </Box>
